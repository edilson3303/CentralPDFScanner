...
OutputBaseFilename=PDF_Scanner_ALAP_Setup_v2.8.1
...
[Icons]
Name: "{commonprograms}\PDF Scanner ALAP"; Filename: "{app}\{#MyAppExeName}"; IconFilename: "{app}\pdf_scanner_feather.ico"; IconIndex: 0
Name: "{commondesktop}\PDF Scanner ALAP"; Filename: "{app}\{#MyAppExeName}"; IconFilename: "{app}\pdf_scanner_feather.ico"; IconIndex: 0; Tasks: desktopicon
