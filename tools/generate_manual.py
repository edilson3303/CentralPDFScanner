...
def mock_screen(title: str, kind: str) -> BytesIO:
    ...
    if kind == "home":
        ...
        sections = [
            ...
            (340, "Edição de PDF", ["Juntar PDFs", "Dividir PDF", "Proteger PDF", "Desproteger PDF", "Remover páginas", "Girar páginas", "Cortar PDF", "Compactar PDF", "Separar em lotes"], False),
...
def build_manual() -> None:
    ...
    chapter("7. Remover, girar, dividir e cortar", "Essas ferramentas utilizam miniaturas para facilitar a escolha das páginas.", "Edição por miniaturas", "thumbnails", ["Remover páginas: selecione as páginas que devem ser excluídas.", "Girar páginas: selecione as páginas e escolha 90, 180 ou 270 graus.", "Dividir PDF: informe intervalos como 1-3,4-6,7-10.", "Cortar PDF: informe em centímetros quanto retirar das margens superior e inferior.", "Escolha o destino e confira o arquivo gerado."], "A numeração mostrada começa em 1.")
    ...
    chapter("13. Diagnóstico e solução de problemas", "O botão Testar scanner gera um relatório sem copiar o conteúdo dos documentos.", "Diagnóstico", "generic", ["Clique em Testar scanner.", "Confira scanners WIA, scanner de rede configurado e Tesseract OCR.", "Copie ou salve o relatório para atendimento técnico.", "Em erro de alimentador, retire folhas presas, alinhe o papel e aguarde o equipamento ficar livre.", "Em erro de rede, confirme que o computador alcança o IP cadastrado."], "Nunca desative controles de segurança do Windows para contornar um erro.")
