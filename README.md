...
Esta versão aguarda corretamente o aquecimento e a preparação da página no vidro e libera os trabalhos de digitalização concluídos.
...
O fluxo do GitHub gera `PDF_Scanner_ALAP_Setup_v2.5.9.exe` com Inno Setup. Para gerar localmente, instale o Inno Setup 6, execute primeiro `build_portable.bat` e depois `build_installer.bat`.
